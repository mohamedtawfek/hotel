...
<!-- css files -->
<link rel="stylesheet" href="{{url('css/bootstrap.css')}}"> <!-- Bootstrap-Core-CSS -->
<link rel="stylesheet" href="{{url('css/style.css')}}" type="text/css" media="all" /> <!-- Style-CSS --> 
<link rel="stylesheet" href="{{url('css/font-awesome.css')}}"> <!-- Font-Awesome-Icons-CSS -->
<!-- //css files -->

<!-- online-fonts -->
<link href="{{url('//fonts.googleapis.com/css?family=Playfair+Display:400,400i,700,700i,900,900i')}}" rel="stylesheet">
<link href="{{url('//fonts.googleapis.com/css?family=Cormorant+Garamond:300,300i,400,400i,500,500i,600,600i,700,700i')}}" rel="stylesheet">
<link href="{{url('//fonts.googleapis.com/css?family=Yanone+Kaffeesatz:200,300,400,700')}}" rel="stylesheet">
<!-- //online-fonts -->

<!-- js -->
<script type="text/javascript" src="{{url('js/jquery-2.1.4.min.js')}}"></script>
<script type="text/javascript" src="{{url('js/bootstrap.js')}}"></script> <!-- Necessary-JavaScript-File-For-Bootstrap --> 
<!-- //js -->
</head>
<body>
<!-- header -->
<div class="header">
	...
	<!--Slider-->
		...
		<h3>Hotel Booking form</h3>
			...
			<form action="{{url('/add/booking')}}" method="POST" class="w3_form_post">
				{{csrf_field()}}
				<div class="w3_agileits_main_grid w3l_main_grid">
					<div class="agileits_grid">
						<h5>Name * </h5>
						<div class="nam">
							<input type="text" name="firstName" placeholder="first_name" required="">
						</div>
						<div class="nam1">
							<input type="text" name="lastName" placeholder="last_name" required="">
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
				...
				<div class="agileits_main_grid w3_agileits_main_grid">
					<div class="wthree_grid">
						<h5>Room Type</h5>
						<select id="category" name="roomType" required="">
				...
				<div class="agileits_w3layouts_main_grid w3ls_main_grid">
					<div class="agilcveinfo_grid">
					<h5>Check In & Time *</h5>
						
						<div class="agileits_w3layouts_main_gridl">
							<input class="date" id="datepicker" name="checkIntime" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '08/13/2016';}" required="">
						</div>
				...
				<div class="agileits_w3layouts_main_grid w3ls_main_grid">
					...
					<h5>Check Out & Time *</h5>
						...
						<div class="agileits_w3layouts_main_gridl">
							<input class="date" id="datepicker1" name="checkOuttime" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '08/13/2016';}" required="">
						</div>
						<div class="agileits_w3layouts_main_gridr">
				...
				<div class="agileinfo_main_grid">
					<div class="agileits_w3layouts_grid">
						...
						<select id="category1" name="numOfguests" required="">
	...
	<div class="w3-agile-about-grids">
		<div class="w3-aglie-about-grid1">
			<div class="col-md-6 w3-about-text-grid">
				<h3>About us</h3>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque sit amet justo imperdiet, consequat risus quis, efficitur urna. Curabitur nec eleifend neque. Donec a aliquam libero.</p>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque sit amet justo imperdiet, consequat risus quis, efficitur urna. Curabitur nec eleifend neque. Donec a aliquam libero.</p>
		...
		<div class="w3-aglie-about-grid2">
			...
			<div class="w3-about-text-heads">
				...
				<h4>Save 20%</h4>
				<p>Sed in elit sit amet risus suscipit venenatis et scelerisque quam. Ut mollis lorem ac turpis mattis, a tristique lacus molestie. Curabitur pretium leo sed tortor ultricies, vitae accumsan lacus pretium.</p>
				<ul class="about-list">
